    ...
    <header className={`sticky top-0 z-10  smooth-transition ${isScrolled ? 'bg-opacity-50 backdrop-blur-lg' : 'bg-transparent'}`}>
      <nav className="container mx-auto flex justify-between items-center p-4">
        ...
        <div className="flex items-center space-x-4">
          <div className="w-[10vw] sm:w-[7vw] px-3 py-1 flex justify-center rounded-full bg-transparent border-2 border-[#1E90FF]">
            <button className="text-[#1E90FF]">Login</button>
          </div>
          <div className="w-[10vw] sm:w-[7vw] px-2 py-1 flex justify-center rounded-full bg-[#1E90FF] text-white">
